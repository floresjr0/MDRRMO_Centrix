...
<header class="header" id="header">
  <div class="header-inner">
    <a href="#" class="logo">
      <div class="logo-mark">
        <!-- SVG Shield/Emergency icon (replaces img) -->
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2L4 6V12C4 16.42 7.42 20.57 12 22C16.58 20.57 20 16.42 20 12V6L12 2Z" fill="white" opacity="0.9"/>
          <line x1="12" y1="8" x2="12" y2="13" stroke="#d63e2c" stroke-width="2.5" stroke-linecap="round"/>
          <circle cx="12" cy="15.5" r="1.2" fill="#d63e2c"/>
        </svg>
      </div>
      <div class="logo-text">
        <h1>MDRRMO</h1>
    ...
    <div class="hero-grid">
      <div>
        ...
        <div class="hero-buttons">
          ...
          <button class="btn-secondary-lg" id="continueBrowsingBtn">
      ...
      <div class="phone-container">
        ...
        <!-- Weather alert card:
             Desktop → absolute-positioned floating beside the phone (via CSS)
             Mobile  → relative, shown inline above the phone mockup (via CSS override) -->
      ...
      <div>
        <div class="footer-brand">
          <div class="footer-icon">
            <!-- SVG Shield icon (replaces img) -->
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2L4 6V12C4 16.42 7.42 20.57 12 22C16.58 20.57 20 16.42 20 12V6L12 2Z" fill="white" opacity="0.9"/>
              <line x1="12" y1="8" x2="12" y2="13" stroke="#e67e22" stroke-width="2.5" stroke-linecap="round"/>
              <circle cx="12" cy="15.5" r="1.2" fill="#e67e22"/>
            </svg>
          </div>
        ...
        <div class="social-links">
          <div class="social-link" onclick="window.open('https://facebook.com','_blank')">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e67e22" stroke-width="1.5">
              <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
            </svg>
          </div>
          <div class="social-link" onclick="window.location.href='mailto:mdrrmo@sanildefonso.gov.ph'">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e67e22" stroke-width="1.5">
...
// Attach click handlers to download buttons and Continue Browsing button
...
// Weather demo element (if added elsewhere on page)
