...
.service-card:hover .service-icon {
  background: rgba(214,62,44,0.12);
  border-color: var(--primary);
}
...
<header class="header" id="header">
  <div class="header-inner">
    <a href="#" class="logo">
      <div class="logo-mark">
        <img src="./screenshots/mdrrmo.png" alt="MDRRMO" onerror="this.src='';this.parentElement.innerHTML='<div class=logo-mark-fallback>M</div>'">
      </div>
      <div class="logo-text">
        <h1>MDRRMO</h1>
  ...
  <div class="container">
    <div class="hero-grid">
      <div>
        ...
        <h1 class="hero-title">
          Ready to Protect.<br>Ready to Serve.
      ...
      <div class="phone-container">
        ...
        <div class="iphone-frame">
          ...
          <div class="iphone-screen">
            <img class="screen-img" src="./screenshots/app-home.png" alt="App Preview" id="appScreenshot" onerror="this.style.display='none';document.getElementById('screenFallback').style.display='flex';">
        ...
        <div class="float-card qr-card" onclick="openModal()">
          <div class="qr-badge">📲 Free App</div>
...
<section class="section" id="services">
  <div class="container">
    ...
    <div class="services-grid">
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><path d="M12 2C8.686 2 6 4.686 6 8c0 5.25 6 13 6 13s6-7.75 6-13c0-3.314-2.686-6-6-6z"/><circle cx="12" cy="8" r="2.5"/></svg></div><h3>Locate Evacuation Centers</h3><p>Interactive map showing all 12 evacuation centers with real-time capacity and amenities.</p></div>
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><path d="M18 8a6 6 0 00-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg></div><h3>Disaster Advisories</h3><p>Real-time official announcements for typhoons, floods, earthquakes, and other hazards.</p></div>
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><circle cx="12" cy="12" r="5"/><line x1="12" y1="2" x2="12" y2="4"/><line x1="12" y1="20" x2="12" y2="22"/></svg></div><h3>Current Weather</h3><p>Live weather data via OpenWeatherMap — temperature, rainfall, and wind speed.</p></div>
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg></div><h3>Select Intended Center</h3><p>Choose your designated evacuation center before disaster strikes — pre-register your family.</p></div>
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><path d="M4 20h16a2 2 0 002-2V8a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2z"/><path d="M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/><line x1="12" y1="11" x2="12" y2="17"/><line x1="9" y1="14" x2="15" y2="14"/></svg></div><h3>Preparedness Tips</h3><p>Automated safety checklists, emergency kit guides, and evacuation route planning.</p></div>
      <div class="service-card fade-up"><div class="service-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#d63e2c" stroke-width="1.6"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg></div><h3>Become As One</h3><p>Join the community resilience movement. Every citizen is a partner in disaster safety.</p></div>
    </div>
  </div>
</section>
...
<section class="steps-section" id="steps">
  <div class="container">
    ...
    <div class="steps-flow">
      ...
      <div class="step-item fade-up"><div class="step-number-circle">5</div><h4>Enter Verification PIN</h4><p>6-digit code via SMS<br><span class="pin-chip">🔐 Verification PIN</span></p></div>
...
<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      <div>
        <div class="footer-brand">
          <div class="footer-icon">
            <img src="./screenshots/mdrrmo.png" alt="MDRRMO" onerror="this.src='';this.parentElement.innerHTML='<div class=footer-icon-fallback>M</div>'">
          </div>
        ...
        <div class="social-links">
          <div class="social-link" onclick="window.open('https://facebook.com','_blank')"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e67e22" stroke-width="1.5"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg></div>
          <div class="social-link" onclick="window.location.href='mailto:mdrrmo@sanildefonso.gov.ph'"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e67e22" stroke-width="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div>
        </div>
      </div>
      ...
      <div class="footer-col">
        <h4>Contact</h4>
        <div class="contact-item"><div class="contact-icon">📍</div><span>Municipal Hall Complex, San Ildefonso, Bulacan 3007</span></div>
        <div class="contact-item"><div class="contact-icon">📞</div><span>(044) 415-9999</span></div>
        <div class="contact-item"><div class="contact-icon">✉️</div><span>mdrrmo@sanildefonso.gov.ph</span></div>
      </div>
    </div>
    <div class="footer-bottom">
      <p>© 2026 CENTRIX · #BidaLagingHanda</p>
    </div>
  </div>
</footer>
...
if (weatherEl) {
  const conditions = ['☀️ Sunny 31°C', '🌤️ Partly Cloudy 29°C', '🌧️ Light Rain 26°C', '⛈️ Thunderstorm 25°C'];
  weatherEl.textContent = conditions[Math.floor(Math.random() * conditions.length)];
}
