            ...
            <div class="sidebar-content">
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="users.php" class="sidebar-link active"><i class="fas fa-users"></i> <span>User Management</span> <?php if($_badgeUsers > 0): ?><span class="sidebar-badge"><?php echo $_badgeUsers; ?></span><?php endif; ?></a></li>
